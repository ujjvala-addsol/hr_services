...
class addsol_hr_biometric(osv.osv):
    _name = 'addsol.hr.biometric'
    _description = "Biometric Device Information"
    _rec_name = 'machine_name'

    _columns = {
        'code': fields.integer('Device Code', required=True),
        'machine_name': fields.char('Device Name', required=True),
        'ip_addr': fields.char('IP Address', size=20),
...
class addsol_hr_biometric_line(osv.osv):
    ...
    _columns ={
        'device_id': fields.many2one('addsol.hr.biometric', 'Device'),
        'employee_id': fields.many2one('hr.employee', 'Employee',required=True),      
        'dept_id': fields.related('employee_id', 'department_id',type='many2one',relation='hr.department',string='Department'),
        'related_user': fields.related('employee_id','user_id',type='many2one',relation='res.users',string='Related User'),
